...
import com.kaya.orderapi.service.OrderService;
...
public class OrderController {
  ...
  @GetMapping
  @PreAuthorize("hasAuthority('read_order')")
  public SuccessResponse<List<OrderResponseDTO>> search(@Valid OrderQueryParamDTO queryParams) {
    var orders = orderService.search(queryParams);
